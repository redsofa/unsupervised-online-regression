...
echo "Running ADWIN with Z1 and Z2 experiment ..."

echo 'Launching Adaptive Model ...'
python main.py ^
    --raw_data_dir "%DATA_ROOT%" ^
    --output_dir "%WORK_ROOT%/adwin_with_z1_z2/lr/air_quality_NMHCGT/%NOW%" ^
...
python .\plotting\main.py ^
    --input_dir "%WORK_ROOT%/adwin_with_z1_z2/lr/air_quality_NMHCGT/%NOW%" ^
    --output_dir "%WORK_ROOT%/adwin_with_z1_z2/lr/air_quality_NMHCGT/%NOW%" ^
    --predictions_file std_AirQualityUCI_NMHCGT_predictions.csv ^
