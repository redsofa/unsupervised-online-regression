...
python main.py \
    ...
    --output_dir ~/data/usup_reg/work/adwin_with_z1_z2/lr/wetlab/$NOW \
    ...
    --drift_detector_config '{"detector": "ADWIN", "required_feature_drifts": 2, "delta": 0.02}' \
    --delta_threshold 0.1e-14 \
